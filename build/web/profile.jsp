<%-- 
    Document   : profile
    Created on : 19-Aug-2023, 11:28:34 pm
    Author     : agamj_d8qc0cg
--%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.app.blog.entities.Category"%>
<%@page import="com.app.blog.helper.ConnectionProvider"%>
<%@page import="com.app.blog.dao.PostDao"%>
<%@page import="com.app.blog.entities.Message"%>
<%@page import="com.app.blog.entities.User"%>
...
%>
<!--// if above object gets a object from user only then the below code will execute otherwise redirected to login page-->
 ...
 <nav class="navbar navbar-expand-lg navbar-dark primary-background">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="nav-link" href="#"><span class="fa fa-address-card"></span> Contacts</a>
      </li>
...
<script>
            $(document).ready(function (e) {
                ...
                $("#add-post-form").on("submit", function (event) {
                    ...
                    // making object of add-post-form form
